...
impl TitleId {
    ...
    #[inline]
    pub fn from_high_and_low(high: TitleIdHigh, low: TitleIdLow) -> Self {
...
impl TitleIdHigh {
    ...
    #[inline]
    pub fn from_platform_and_category(platform: Platform, category: Category) -> Self {
...
impl Category {
    ...
    #[inline]
    pub fn is_addoncontents(&self) -> bool {
    ...
    /// flag in the category section
    #[inline]
    pub fn is_cannotexecution(&self) -> bool {
    ...
    #[inline]
    pub fn is_requirebatchupdate(&self) -> bool {
    ...
    /// bitmask flag in the category section
    #[inline]
    pub fn is_notrequireuserapproval(&self) -> bool {
    ...
    /// bitmask flag in the category section
    #[inline]
    pub fn is_notrequirerightformount(&self) -> bool {
    ...
    /// bitmask flag in the category section
    #[inline]
    pub fn is_canskipconvertjumpid(&self) -> bool {
